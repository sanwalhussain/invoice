...
const InvoiceCard = () => {
  return (
    <div className="outline outline-0 cursor-pointer bg-secondary flex py-4 rounded-md items-center mb-4 hover:outline-1 outline-primary">
      ...
      <div className="flex items-center bg-status_green bg-status_green_light py-3 px-7 rounded-lg ml-10">
        <div className="rounded-full w-2 h-2 bg-status_green mr-3"></div>
        <p className="text-sm text-status_green">Paid</p>
      </div>
      <Image src={iconArrowRight} alt="icon-right" className="ml-6" />
    </div>
  );
};
